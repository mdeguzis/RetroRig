...
Build-Depends: debhelper (>= 9.20130604), dpkg-dev (>= 1.16.1.1), libfreetype6-dev, libgl1-mesa-dev | libgl-dev, libglu1-mesa-dev | libglu-dev, libminizip-dev, libpng-dev, libsdl2-dev, pkg-config, zlib1g-dev | libz-dev
Package-List:
